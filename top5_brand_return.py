...
top5_brand_df = pd.read_sql_query("""select top 10 prinfoskf.BRAND as BRAND,ISNULL(sum(case when TRANSTYPE<>1 then EXTINVMISC  *-1 end), 0) as returnA,
...
#plt.show()
plt.savefig("./return_bar_with_value.png")

print('12. only return bar generated without values')