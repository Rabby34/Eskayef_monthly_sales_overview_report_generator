...
sales_values=[90,10,20,60,30,20,15,35,10,55,100]
...
colors=['#eaeaea','#540C6F','#540C6F','#540C6F','#540C6F','#540C6F','#540C6F','#540C6F','#540C6F','#540C6F','#540C6F']
...
plt.tight_layout()
# plt.show()
plt.savefig("left_mirror.png")

print('left morror generated')